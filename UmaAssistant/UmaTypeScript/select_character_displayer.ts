function createCharacterImageButton(jp_event_owner: string, tw_event_owner: string, img_name: string): void
{
    ...
    */ 
    //https://raw.githubusercontent.com/kakuun333/UmaAssistant/main/UmaAssistant/UmaMisc/Image/Character/i_1.png
    // char_img.src = `../UmaMisc/Image/Character/${img_name}`;
    char_img.src = `https://raw.githubusercontent.com/kakuun333/UmaAssistant/main/UmaAssistant/UmaMisc/Image/Character/${img_name}`;
