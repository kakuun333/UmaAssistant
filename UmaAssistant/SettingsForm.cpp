...
#pragma region Button Click
	System::Void SettingsForm::test_btn_Click(System::Object^ sender, System::EventArgs^ e)
	{
		...
		//raceInfo->Add("raceName", u8"函館ジュニアステークス");
		//raceInfo->Add("raceDate", u8"ジュニア級 7月後半");
		//raceInfo->Add("raceGrade", u8"G3");
		//raceInfo->Add("racecourse", u8"函館");
		//raceInfo->Add("raceTrack", u8"芝");
		//raceInfo->Add("raceDirection", u8"右");
		//raceInfo->Add("raceDistanceType", u8"短距離");
