...
namespace global
{
	namespace path
	{
		...
		// WebBrowser
		gcroot<System::String^> choiceWebBrowser		= "file://" + global::path::currentDir + "/UmaWeb/choice.html";
		gcroot<System::String^> characterNameWebBrowser = "file://" + global::path::currentDir + "/UmaWeb/character_name.html";
